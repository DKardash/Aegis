...
- Проверка NVIDIA-видеокарты, текущей и актуальной версии драйвера.
- Автоматическое скачивание, распаковка и тихая установка NVIDIA-драйвера.
- Установка NVIDIA Control Panel через winget, если панель отсутствует.
