...
- устанавит родное разрешение;
- выберет максимально доступную герцовку для этого разрешения;
- сбросит цветовые настройки NVIDIA (яркость, контрастность, гамму, цифровую интенсивность и оттенок).
