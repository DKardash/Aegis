<div align="center">
  ...
  <h1>Aegis</h1>
  <p><strong>Автоматизация диагностики, стресс-тестирования и обслуживания компьютеров</strong></p>
</div>

Aegis — утилита для автоматизации сервисных работ на Windows-ПК. Она запускает внешние программы по аргументам командной строки, последовательно выполняет заданные действия, обновляет драйверы NVIDIA, настраивает параметры дисплеев, отправляет скриншоты в Telegram и ведёт отдельные журналы работы.
...
| `NVIDIA.Panel` | Установить NVIDIA Control Panel без видеодрайвера. |
...
- более подробная отчётность в Telegram по результатам FurMark, AIDA64 и Victoria;
- поддержка OCCT.
