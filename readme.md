...
| `Display.Normalize` | Установить родное разрешение, максимальную герцовку и сбросить цветовые настройки NVIDIA. |
...
## Нормализация разрешения, герцовки и цветовых настроек NVIDIA
